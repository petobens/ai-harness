...
Given a list of git commit messages (subject and body), write a changelog
entry in the [Keep a Changelog](https://keepachangelog.com/en/1.0.0/) style.
...
- Under it, group changes under the appropriate sections: "Added", "Changed",
  "Fixed", "Removed", etc.
- For each commit, write a single, concise bullet point summarizing the main
  change.
