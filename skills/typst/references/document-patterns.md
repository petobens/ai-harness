...
Read only the section for the selected document type or component. Inspect the
corresponding template source for its full parameter list and implementation.
